...
func (s *server) routes() http.Handler {
	...
	mux.Handle("GET /api/gift-packs", s.scopedRoute(permissionStarGiftsRead, http.HandlerFunc(s.handleBuiltinGiftPacksAPI)))
	mux.Handle("GET /api/gift-packs/{pack_id}/animations/{slug}", s.scopedRoute(permissionStarGiftsRead, http.HandlerFunc(s.handleBuiltinGiftPackAnimationAPI)))
	...
	mux.Handle("POST /api/actions/import-builtin-gift-pack", s.scopedRoute(permissionStarGiftsManage, http.HandlerFunc(s.handleImportBuiltinGiftPackAPI)))
