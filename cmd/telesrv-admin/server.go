...
func (s *server) routes() http.Handler {
	...
	mux.Handle("GET /api/star-gift-catalog/default-pack", s.scopedRoute(permissionStarGiftsRead, http.HandlerFunc(s.handleDefaultGiftPackAPI)))
	...
	mux.Handle("POST /api/actions/import-default-gift-pack", s.scopedRoute(permissionStarGiftsManage, http.HandlerFunc(s.handleImportDefaultGiftPackAPI)))
