...
func (s *server) routes() http.Handler {
	...
	mux.Handle("GET /api/star-gift-catalog", s.scopedRoute(permissionStarGiftsRead, http.HandlerFunc(s.handleStarGiftCatalogAPI)))
	mux.Handle("GET /api/star-gift-catalog/{gift_id}/animation", s.scopedRoute(permissionStarGiftsRead, http.HandlerFunc(s.handleStarGiftCatalogAnimationAPI)))
	mux.Handle("GET /api/star-gift-catalog/{gift_id}/collectibles", s.scopedRoute(permissionStarGiftsRead, http.HandlerFunc(s.handleStarGiftCollectiblesAPI)))
	mux.Handle("GET /api/star-gift-catalog/{gift_id}/collectibles/{kind}/{attribute_id}/animation", s.scopedRoute(permissionStarGiftsRead, http.HandlerFunc(s.handleStarGiftCollectibleAnimationAPI)))
	mux.Handle("GET /api/gift-packs", s.scopedRoute(permissionStarGiftsRead, http.HandlerFunc(s.handleGiftPacksAPI)))
	mux.Handle("GET /api/gift-packs/{pack_id}/animations/{slug}", s.scopedRoute(permissionStarGiftsRead, http.HandlerFunc(s.handleGiftPackAnimationAPI)))
	...
	mux.Handle("POST /api/actions/create-star-gift-catalog-entry", s.scopedRoute(permissionStarGiftsManage, http.HandlerFunc(s.handleCreateStarGiftCatalogEntryAPI)))
	mux.Handle("POST /api/actions/set-star-gift-catalog-enabled", s.scopedRoute(permissionStarGiftsManage, http.HandlerFunc(s.handleSetStarGiftCatalogEnabledAPI)))
	mux.Handle("POST /api/actions/set-star-gift-catalog-sort-order", s.scopedRoute(permissionStarGiftsManage, http.HandlerFunc(s.handleSetStarGiftCatalogSortOrderAPI)))
	mux.Handle("POST /api/actions/publish-star-gift-collectibles", s.scopedRoute(permissionStarGiftsManage, http.HandlerFunc(s.handlePublishStarGiftCollectiblesAPI)))
	mux.Handle("POST /api/actions/give-star-gift", s.scopedRoute(permissionStarGiftsManage, http.HandlerFunc(s.handleGiveStarGiftAPI)))
	mux.Handle("POST /api/actions/upload-gift-pack", s.scopedRoute(permissionStarGiftsManage, http.HandlerFunc(s.handleUploadGiftPackAPI)))
	mux.Handle("POST /api/actions/delete-gift-pack", s.scopedRoute(permissionStarGiftsManage, http.HandlerFunc(s.handleDeleteGiftPackAPI)))
	mux.Handle("POST /api/actions/import-gift-pack", s.scopedRoute(permissionStarGiftsManage, http.HandlerFunc(s.handleImportGiftPackAPI)))
